...
module.exports = function (restClient) {
    ...
    module.create = function (customerToken, customerId = null, campaignToken = undefined) {
        data = {};
        if (campaignToken) {
            data = { campaignToken: campaignToken };
        }
        
        if (customerId) {
            return restClient.post('/customers/' + customerId + '/carts', data, customerToken);
        } else {
            if (customerToken) {
                return restClient.post('/carts/mine', data, customerToken);
            } else 
            {
                return restClient.post('/guest-carts', data);
            }
        }
    }    
