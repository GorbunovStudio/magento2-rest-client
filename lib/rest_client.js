        ...
        return new Promise(function (resolve, reject) {
            request({
                ...
                if (error) {
                    ...
                    } else if (body && body.hasOwnProperty('messages')) {
                        if (body.messages.hasOwnProperty('error') && Array.isArray(body.messages.error)) {
                            errorMessage = body.messages.error.map((error) => error.message).join('; ');
                        } else {
                            errorMessage = JSON.stringify(body.messages);
                        }
                    } else if (body) {
